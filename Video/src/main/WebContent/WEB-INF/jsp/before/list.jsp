...
<body class="w100">
        ...
        <div class="container">
            <span>欢迎来到IT培训的黄埔军校——智游教育！</span>
	            ...
	            <div id="userBlock" style="display:none;float:right">
	               ...
	               <a href="${pageContext.request.contextPath}/user/TZ2" >个人中心</a>
    ...
    <nav class="w100">
        <div class="container">
            ...
            <ul class="text_13 f_right">
                ...
                <li>
                    <a href="http://www.zhiyou100.com/ga oxinjiuye/index.html" target="_blank">高薪就业</a>
                </li>
                <li>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/findallcourse1.action?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/course/findallcourse1.action?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}//course/findallcourse1.action?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/course/findallcourse1.action?subjectId=11">
    ...
    <div class="mask hidden" id="reg">
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="regForm" action="user/sendEmail.action">
                    <h3>新用户注册</h3>
