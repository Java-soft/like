...
<body>
 <form class="navbar-form navbar-left"  action="${pageContext.request.contextPath}/course/findallcourse.action">
...
<div id="zz">
    ...
    <div class="navbar-header" id="op">
        <a class="navbar-brand" id="wp" href="${pageContext.request.contextPath}/course/TZ.action">添加</a>
	...
	<div id="tb">
		...
		<c:forEach items="${course}" var="v">
							...
							<tr>
								...
								<th><a href="${pageContext.request.contextPath}/course/selectbyID?id=${v.id}">修改</a> </th>
								<th><a href="${pageContext.request.contextPath}/course/courseDelete?id=${v.id}">删除</a> </th>
