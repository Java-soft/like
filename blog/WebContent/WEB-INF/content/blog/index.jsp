		...
		<div class="col-xs-9">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-inline" action="blog/mhcxofallBlog.action" method="post" id="queryPageForm">
						<%-- <input type="hidden" id="queryPageNum" name="pageNum" value="${queryInfo.pageNum}"> --%>
						<div class="form-group">
							<label for="queryTitle">标题</label>
							<input type="text" class="form-control" name="title" id="title" placeholder="标题" value="${queryInfo.title}">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<input type="text" class="form-control" name="insertTime" id="insertTime" placeholder="yyyy-mm-dd" value="${queryInfo.insertTime }">
						</div>
						<div class="form-group">
							<label for="queryEndTime">到</label>
							<input type="text" class="form-control" name="updateTime" id="updateTime" placeholder="yyyy-mm-dd" value="${queryInfo.updateTime }">
						</div>
